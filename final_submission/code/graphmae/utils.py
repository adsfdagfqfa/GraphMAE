...
def build_args():
    ...
    parser.add_argument("--mask_strategy", type=str, default="random", choices=["random", "pagerank_preserve_curriculum"])
    parser.add_argument("--pagerank_mask_ratio", type=float, default=0.25,
                        help="final fraction of masked nodes sampled by inverse PageRank when mask_strategy=pagerank_preserve_curriculum")
